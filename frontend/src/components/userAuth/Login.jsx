                ...
                <div class="bg-gray-200 flex rounded-2xl shadow-lg p-2 px-2 justify-center">
                    ...
                    <div class="md:w-1/2 px-1 md:pl-px p-2 items-center">
                        ...
                        <form action="" class="flex flex-col gap-4">
                            ...
                            <button class="bg-[#ff9863] rounded-xl text-white py-2 hover:scale-105 duration-300">Login</button>
                        </form>
                        ...
                        <div class="mt-2 text-sm flex justify-between items-center text-[#002D74]">
                            ...
                            <button class="py-2 px-5 bg-[#ff9863] border rounded-xl hover:scale-110 duration-300 text-white">Register</button>
